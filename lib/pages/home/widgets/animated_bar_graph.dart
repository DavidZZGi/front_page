...
class BarChartSample2State extends State<BarChartSample2> {
  ...
  void initState() {
    ...
    final barGroup2 = makeGroupData(1, 16, 18);
    final barGroup3 = makeGroupData(2, 18, 20);
    final barGroup4 = makeGroupData(3, 13, 16);
    final barGroup5 = makeGroupData(4, 17, 17);
    final barGroup6 = makeGroupData(5, 10, 15);
    final barGroup7 = makeGroupData(6, 9, 13);
